...
\begin{definitionbox}
  \textbf{Komplexní čísla} jsou množina čísel, která zahrnují reálná čísla, ale také imaginární čísla. Značíme je $\mathbb{C} = \{a + bi\ |\ a, b\in\mathbb{R}\}$, kde $i$ je imaginární jednotka, která je definována jako $i = \sqrt{-1}$
\end{definitionbox}
...
Ke komplexním číslům se ještě vratíme, protože jsou velice zajímavé a důležité. Nyní si jen pojďme uvědomit množinový vztah mezi výše zmíněnými číslenými množiny.
\begin{equation}
